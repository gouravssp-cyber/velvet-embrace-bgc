...
const SeoSection = () => {
    return (
        <section className="relative bg-background section-padding py-16 md:py-24" id="why-choose-us">
            ...
            <div className="max-w-7xl mx-auto my-12">
                <motion.p
                    ...
                    viewport={{ once: true }}
                    className="mb-4 text-sm tracking-luxury uppercase text-primary font-body text-center"
                >
                    Discover the Best
                </motion.p>
                ...
                >
                    Choose Immature Dehradun Escorts For An Erotic Play
                </motion.h2>
                ...
                >
                    <p>
                        Dehradun independent escorts on come up with the services more than the erotic encounter. They create a friendly environment to make their clients feel more confident for the sex sessions. Many people hesitate to reveal their fantasies. But with some romantic hugs, gentle care, and spending time together help you talk about your hidden fantasies in details. You will be enjoying all those things that you dream of. It is truly an amazing experience for you to enjoy your sexual fantasies with the top-rated Dehradun independent escorts.
                    </p>
                    <p>
                        Whether you are looking for gay escorts, swingers, male escorts, transsexuals, and masseurs for sex massage, is the only place where you can find your dream girl. All our escorts are professionals and skilled to make you sexually satisfied. They will surely drive you crazy with the services from foreplays to intense sex acts. You will get princely treatment in bed. They know how to stimulate your genitals and take you through the amazing experiences. Attain your orgasm with the services that you fantasize about always. Finally, you can have easy access to the sexy independent escorts in Dehradun as they are available through phone calls, WhatsApp number, and emails. You don’t need to wait for any kind usual business hour-they will answer to your query round the clock without any delay. Reach out to them through the escorts’ phone number Dehradun or send the WhatsApp escorts Dehradun a message.
                    </p>
                </motion.div>
            ...
            <div className="max-w-7xl mx-auto my-12">
                ...
                >
                    {/* Left: Image */}
                    <div className="relative my-6 overflow-hidden rounded-lg shadow-2xl order-1">
                        <motion.img
                            initial={{ opacity: 0, scale: 1.05 }}
                            whileInView={{ opacity: 1, scale: 1 }}
                            viewport={{ once: true }}
                            ...
                            loading="lazy"
                        />
                        {/* Subtle overlay for premium/luxury vibe */}
                        <div className="absolute inset-0 bg-gradient-to-t from-background/40 to-transparent pointer-events-none" />
                    </div>
